...
//        alert('vamos a crear la base datos');
        baseD = window.sqlitePlugin.openDatabase({name: 'misfeeds.db', location: 1}, function(transaction) {
